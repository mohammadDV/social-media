...
Route::middleware(['throttle:60,1'])->group(function() {
    ...
    Route::get('/author-posts/{user}', [PostController::class, 'authorPosts'])->name('site.author-posts.index');
    ...
    Route::get('/page/{slug}', [PageController::class, 'getActivePage'])->name('site.single-page');
